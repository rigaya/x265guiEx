...
#define AUO_VERSION          0,3,13,0
#define AUO_VERSION_STR      "3.13β"
#define AUO_NAME_WITHOUT_EXT "x265guiEx"
#define AUO_NAME             "x265guiEx.auo"
#define AUO_NAME_W          L"x265guiEx.auo"
#define AUO_FULL_NAME        "拡張 x265 出力(GUI) Ex べ～た"
#define AUO_VERSION_NAME     "拡張 x265 出力(GUI) Ex べ～た "AUO_VERSION_STR
#define AUO_VERSION_INFO     "拡張 x265 出力(GUI) Ex べ～た (x265guiEx) "AUO_VERSION_STR" by rigaya"
