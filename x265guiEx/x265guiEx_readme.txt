...
【どうでもいいメモ】
2026.09.11 (5.12)
- エラー終了時にAviUtlごと落ちてしまう場合があったのを修正。
- 同梱の実行ファイルを更新。(x265_4.3+24)

2026.08.25 (5.11)
- システム全体のハンドル数が非常に多い環境でのエラー回避。
- 同梱の実行ファイルを更新。(x265_4.3+17)

2026.08.12 (5.10)
- 「画面比から自動計算」のアスペクト比設定が保存されない問題を修正。
- 同梱の実行ファイルを更新。(x265_4.3+6)
